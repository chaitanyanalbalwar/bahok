...
public class PathFinder extends AsyncTask<String, Void, PolylineOptions> {

    private final String TAG = "GetPathFromLocation";
    private final String API_KEY;
    private final LatLng source;
    private final LatLng destination;
    private final IPathFinderListener resultCallback;

    public PathFinder(LatLng source, LatLng destination, String API_KEY, IPathFinderListener resultCallback) {
        this.source = source;
        this.destination = destination;
        this.resultCallback = resultCallback;
        this.API_KEY = "AIzaSyCEUpMCzyUSq20aQbmtH90UvrQZUvGyQkg";//API_KEY;
    }
